...
const Cart = () => {
    ...
    return (
        <>
            <div className={`fixed right-0  top-0 w-full lg:w-[20vw] h-full  p-5 bg-white ${activeCart ? "translate-x-0" : " translate-x-full"} transition-all duration-500 z-10`}>
                ...
                <div className='absolute bottom-0'>
                    ...
                    <button onClick={()=> navigate("/success")}
                     className={`bg-green-500 font-bold px-3 text-white py-2 rounded-lg w-[90vw] lg:w-[18vw] "}`} >Checkout</button>
                </div>
